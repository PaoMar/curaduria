...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { anio: @datum.anio, definicion: @datum.definicion, siglas: @datum.siglas, valor: @datum.valor }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { anio: @datum.anio, definicion: @datum.definicion, siglas: @datum.siglas, valor: @datum.valor }
    assert_redirected_to datum_path(assigns(:datum))
  end
